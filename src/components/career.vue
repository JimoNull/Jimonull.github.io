<template>
  <div>
    <section class="text-center m-10">
      ...
      <div class="flex text-center justify-center w-full m-auto md:w-9/12">
        <div class="bg-white py-2">
          <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
            <div class="md:pt-1">
              <div class="text-center md:text-left">
              <p class="text-indigo-500 font-bold">2019/4-2020/11</p>
              <h2 class="text-gray-800 text-2xl sm:text-3xl font-bold text-center md:text-left mb-4 md:mb-6">株式会社NEXER
              </h2>
              <p class="text-gray-500 text-left sm:text-lg mb-4 md:mb-6">
                SEO担当のエンジニア。クライアントサイトの改善施策の提案と実装、自社サイトの作成と更新などを主に行っていました。また、アルバイトの業務を取りまとめ、作業進捗の管理などにも従事していました。
              </p>
              </div>
              <div class="text-center md:text-left">
      ...
      <div class="flex text-center justify-center w-full m-auto md:w-9/12">
        <div class="bg-white py-2">
          <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
            <div class="md:pt-8">
              <div class="text-center md:text-left">
              <p class="text-indigo-500 font-bold">2018/1-2018/11</p>
              <h2 class="text-gray-800 text-2xl sm:text-3xl font-bold text-center md:text-left mb-4 md:mb-6">株式会社GameWith
              </h2>
              <p class="text-gray-500 text-left sm:text-lg mb-4 md:mb-6">
                ライターとして、「GameWith」サービス内のゲーム攻略サイト運営に携わっていました。サイト運営者として記事作成のみではなく、グーグルアナリティクスを利用したサイト改善の提案、それらの施策立案と実行なども行っていました。
              </p>
              </div>
              <div class="text-center md:text-left">
      ...
      <div class="flex text-center justify-center w-full m-auto md:w-9/12">
        <div class="bg-white py-2">
          <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
            <div class="md:pt-8">
              <div class="text-center md:text-left">
              <p class="text-indigo-500 font-bold">2017/4-2017/10</p>
              <h2 class="text-gray-800 text-2xl sm:text-3xl font-bold text-center md:text-left mb-4 md:mb-6">株式会社オプティマ
              </h2>
              </div>
              <div class="text-center md:text-left">
